...
const char *WINDOWTITLE = { "Particle System -- Jonathan Jones" };
...
const float RMIN = 	{  90.f };
const float RMAX = 	{  120.f };
const float RADIUS = { 3.f };
const float TMIN = 	{ 0.0 };
const float TMAX = 	{ 50.0 };
const float THETAMIN = 	{ M_PI / 4.f };
const float THETAMAX = 	{ M_PI / 1.5f };
const float VELMIN = 	{ 40.f };
const float VELMAX = 	{ 80.f };
...
Display( void )
{
	...
	if( WhichProjection == ORTHO )
		...
		glOrtho( -300., 300.,  -300., 300., 0.1, 10000. );
	else
